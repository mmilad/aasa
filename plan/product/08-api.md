...
**MVP v0.1:** normative contract — [api-v1-mvp.md](../wiki/requirements/api-v1-mvp.md) (route table, errors, auth). Auth per [ADR-0003](../wiki/decisions/ADR-0003-secrets-and-exposure.md). First-party **Next.js** admin consumes this API per [ADR-0005](../wiki/decisions/ADR-0005-local-admin-ui-nextjs.md) (Phase C5 in [implementation-backbone.md](../wiki/implementation-backbone.md)). Broader surface (mods/jobs/players WebSocket) rolls in post–Phase C3 per backbone.
